...
An instance of an {{site.data.keyword.blockchainfull_notm}} Platform service.
...
See [Member](/docs/blockchain-multicloud?topic=blockchain-multicloud-glossary#glossary-member).
...
See [Chaincode](/docs/blockchain-multicloud?topic=blockchain-multicloud-glossary#glossary-chaincode).
...
See [Current state](/docs/blockchain-multicloud?topic=blockchain-multicloud-glossary#glossary-current-state).
